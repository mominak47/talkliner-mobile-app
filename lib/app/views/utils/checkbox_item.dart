      ...
      children: [
        Row(
          children: [
            ...
            SizedBox(width: 8),
            Text(title, style: TextStyle(fontSize: 16,color: TalklinerThemeColors.gray700, fontWeight: FontWeight.w500),),
          ],
        ),
        Checkbox(
          value: false,
          ...
          side: BorderSide(color: TalklinerThemeColors.gray040, width: 2),
        ),
      ],
    );
  }
