...
class RecentItemCard extends StatelessWidget {
  const RecentItemCard({super.key, required this.recentItem, required this.onTapIconColor, required this.onTap, required this.isSelected});
    ...
    return ElevatedButton(
      ...
      onLongPress: (){
        showDialog(context: context, builder: (context) => AlertDialog(
          title: Text('Delete'),
          content: Text('Are you sure you want to delete this recent item?'),
          actions: [
      ...
      child: Row(
        ...
        children: [
            ...
            child: Column(
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                    color: isDarkMode ? TalklinerThemeColors.gray030 : TalklinerThemeColors.gray900,
                ...
                Row(
                  children: [
                    ...
                    Icon(
                      isMyMessage ? LucideIcons.arrowDownRight : LucideIcons.arrowUpRight, size: 16,
                      color: isMyMessage ? TalklinerThemeColors.green500 : TalklinerThemeColors.primary500,
                    ),
                    const SizedBox(width: 4),
                    Expanded(
                      child: Text(
          ...
          Column(
            ...
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Text('01.01.2025', style: TextStyle(fontSize: 12, color: isDarkMode ? TalklinerThemeColors.gray050 : TalklinerThemeColors.gray300)),
              Text('04:32pm', style: TextStyle(fontSize: 12, color: isDarkMode ? TalklinerThemeColors.gray050 : TalklinerThemeColors.gray300))
            ],
          )
        ],
      ),
